...
class FreindsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create freind" do
    assert_difference('Freind.count') do
      post freinds_url, params: { freind: { email: @freind.email, first_name: @freind.first_name, phone: @freind.phone } }
    end
  ...
  test "should update freind" do
    patch freind_url(@freind), params: { freind: { email: @freind.email, first_name: @freind.first_name, phone: @freind.phone } }
